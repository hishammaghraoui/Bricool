...
public class UserHelperClass implements Serializable {
    String name, username, email, phoneNo, password , profilepic;
    ...
    public UserHelperClass(String name, String username, String email, String phoneNo, String password , String profilepic ) {
        this.name = name;
        this.username = username;
        this.email = email;
        this.phoneNo = phoneNo;
