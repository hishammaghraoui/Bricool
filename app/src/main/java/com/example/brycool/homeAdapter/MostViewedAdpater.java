...
public class MostViewedAdpater extends RecyclerView.Adapter<MostViewedAdpater.MostViewedViewHolder> {
    ...
    ArrayList<MostViewdHelperClass> mostViewedLocations;

    public MostViewedAdpater(ArrayList<MostViewdHelperClass> mostViewedLocations) {
    ...
    public void onBindViewHolder(@NonNull MostViewedViewHolder holder, int position) {
        MostViewdHelperClass helperClass = mostViewedLocations.get(position);
